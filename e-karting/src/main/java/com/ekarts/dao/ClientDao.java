...
public class ClientDao {
	...
	public List<Client> listar() {
		String SQL_SELECT = "SELECT cli_id, cli_nif, cli_name, cli_surname, cli_email, cli_phone, cli_balance " + " FROM client";
	...
	public List<Client> getListClientPremium() {
		String SQL_SELECT = "SELECT cli_id, cli_nif, cli_name, cli_surname, cli_email, cli_phone, cli_balance " +
							" FROM client WHERE cli_balance >= 3000";
		Connection conn = null;
		PreparedStatement stmt = null;
		ResultSet rs = null;
		Client client = null;
	...
	public Client findById(Client client) {
		String SQL_SELECT_BY_ID = "SELECT cli_id, cli_nif, cli_name, cli_surname, cli_email, cli_phone, cli_balance "
	...
	public int create(Client client) {
		String SQL_INSERT = "INSERT INTO client(cli_nif, cli_name, cli_surname, cli_email, cli_phone, cli_balance) "
				+ " VALUES(?, ?, ?, ?, ?, ?)";
		Connection conn = null;
		PreparedStatement stmt = null;
		int rows = 0;
