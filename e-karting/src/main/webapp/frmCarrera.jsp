...
<html lang="es">
    ...
    <body>
        ...
        <section id="actions" class="py-4 mb-4 bg-light">
		    <div class="container">
		        <div class="row">
                    ...
                    <div class="col-md-3 mt-2">
                        <a href="${pageContext.request.contextPath}/client?action=listPremium" class="btn btn-primary btn-block">
                    ...
                    <div class="col-md-3 mt-2">
                        <a href="${pageContext.request.contextPath}/carrera?action=list" class="btn btn-primary btn-block">
                            <i class="fas fa-eye"></i> Ver Carreras
                        </a>
                    </div>
		        </div>
		    </div>
        ...
        <!--Listado Clientes --> 
        <jsp:include page="/listCarreras.jsp"/>
        
        <!-- Agregar cliente MODAL -->
		<jsp:include page="/addClient.jsp"/>

        <jsp:include page="/addCarrera.jsp"/>
