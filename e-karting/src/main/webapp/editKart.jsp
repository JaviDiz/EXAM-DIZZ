...
<form name="frm-kart" action="${pageContext.request.contextPath}/kart" method="POST" class="was-validated">
    ...
    <section id="actions" class="py-4 mb-4 bg-light">
        <div class="container">
            <div class="row">
                <div class="col-md-3">
                    <a href="frmKart.jsp" class="btn btn-ligth btn-block">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select id="tipo" name="tipo" class="form-control">
                                    ...
                                    <option value="E_KART">eléctrico</option>
                                </select>
                            </div>
                            <div class="form-group">
                                <label for="precio">Precio por minuto</label>
                                <input type="number" class="form-control" name="precio" step=".01" required value="${kart.pricePerMinute}">
                            </div>
                        </div>
                    </div>
                </div>
